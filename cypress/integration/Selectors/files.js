export default
{
    ...
    propertyAddressInputField : "[role='combobox']",
    ...
    borrowerDetails:'//div[@data-testid="file-tabs"]/div[2]/div[1]/div[2]',
    borrowerName:'//div[@data-testid="file-tabs"]/div[2]/div[1]/div[2]/div/span[2]',
    borrowerPhoneNumber:'//div[@data-testid="file-tabs"]/div[2]/div[1]/div[2]/div[2]/div//div[2]',
    borrowerEmail:'//div[@data-testid="file-tabs"]/div[2]/div[1]/div[2]/div[2]/div//div[3]',
    borrowerSSN:'//div[@data-testid="file-tabs"]/div[2]/div[1]/div[2]/div[2]/div//div[4]',
    ...
    addedDocumentNameInServicingOrderFileDetailsPage:'//div[@class="table-body"]/div[last()]/div/div[@class="table-cell"][1]/div/span',
    addedDocumentName:'//div[@class="table-body"]/div[last()]//div[@class="table-cell"]',
    ...
    filesList:'//tbody/tr',
    addedOrderInFileDetailsPage:'//div[@data-testid="StavvizCard"]/div/div[@class="subtitle"]',
    ...
    editButtonOfAnOrderl:'//div[@data-testid="StavvizCard"][1]/div/div[2]/div/div',
    ...
    vendorNameInOrder:'//div[@data-testid="StavvizCard"][1]/div[2]/div[5]/div[2]',
    statusOfOrder:'//div[@data-testid="StavvizCard"][1]/div[2]/div[1]/div[2]/div/div/text()',
    ...
    titleOrderButtonInCreateOrder:'//button[@data-testid="option-creation-button-title"]',
    settlementOrderBtttonInCreateOrder:'//button[@data-testid="option-creation-button-settlement"]',
    foreclosureOrderButtonInCreateOrder:'//button[@data-testid="option-creation-button-foreclosure"]',
    createOrderBttnInReviewPage:'//button[text()="Create Order"]',
    orderTypeText:'//div[text()="Order Type"]/../text()',
    uploadDocumentFiledOfForeclosureOrder:'//input[@id="upload-document-foreclosure-documents"]',
    addeSignPacketBttn:'//button[text()="+ Add eSign packet"]',
}